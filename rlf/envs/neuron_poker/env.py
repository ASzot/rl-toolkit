...
from rlf.envs.neuron_poker.hand_evaluator import get_winner
from rlf.envs.neuron_poker.helper import flatten
...
class HoldemTable(Env):
    ...
    def __init__(self, initial_stacks=100, small_blind=1, big_blind=2, render=False, funds_plot=True,
        ...
        if use_cpp_montecarlo:
            ...
            from rlf.envs.neuron_poker.montecarlo_python import get_equity
    ...
    def _agent_is_autoplay(self, idx=None):
        if not idx:
            return self.current_player.agent_obj.autoplay
        return self.players[idx].agent_obj.autoplay
